...
java -jar payara/payara-micro.jar --deploy oscar-service/oscar-web/target/oscar-web.war --port 9291 --sslport 9292 &

sleep 10

echo "Starting Oscar Service Instance 2 on port 9391/9392..."
java -jar payara/payara-micro.jar --deploy oscar-service/oscar-web/target/oscar-web.war --port 9391 --sslport 9392 &

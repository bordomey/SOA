...
public class ServiceConfig {
    ...
    private void loadProperties() {
        ...
        try (InputStream input = getClass().getClassLoader().getResourceAsStream("application.properties")) {
            if (input == null) {
                ...
                // Set default values
                properties.setProperty("movie.service.base.url", "https://localhost:9192/movie-service/api");
            } else {
    ...
    public String getMovieServiceBaseUrl() {
        return properties.getProperty("movie.service.base.url", "https://localhost:9192/movie-service/api");
    }
}